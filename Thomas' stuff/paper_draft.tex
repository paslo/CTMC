...
\begin{algorithm}[H]
  \caption{Numerically compute lower expectation of $f\in\gambles_\times(\states^{u\cup v}).$ {\bf ATTN:} I know it's a bit verbose, and can be made a lot shorter. Not sure if that would improve the clarity though.

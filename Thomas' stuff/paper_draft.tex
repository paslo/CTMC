...
We start by generalizing transition matrices $T$ to lower transition operators $\lt$, as follows.
...
We conclude with two results about the set $\underline{\mathcal{T}}$ of all lower transition operators. As the first result shows, this set is closed under composition.
...
\noindent {\bf Dit ding moeten we ergens kwijt. Misschien lemma van maken en in appendix droppen?} We next give some additional useful properties of the norm of these operators.

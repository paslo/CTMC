...
As a result of all these assumptions, continuous-time Markov chains can be described using convenient analytic expressions. 
...
In this example, the defining assumptions of a standard continuous-time Markov chain impose rather strict conditions on our model. 

...
\begin{equation*}
[T_{t,\,x_u}^sf](x_t)
=\Big[T_{t_0,\,x_u}^{t_1}\Bigg(\prod_{i=1}^{n-1}T_{t_i,\,x_{u\cup\{t\}}}^{t_{i+1}}\Bigg)f\Big](x_t)
\end{equation*}
\end{lemma}
\begin{proof}
...
\begin{equation*}
[T_{t,\,x_u}^sf](x_t)
=\Big[T_{t_0,\,x_u}^{t_2}\Bigg(\prod_{i=2}^{n-1}T_{t_i,\,x_{u\cup\{t\}}}^{t_{i+1}}\Bigg)f\Big](x_t)
=\Big[T_{t_0,\,x_u}^{t_1}
T_{t_1,\,x_{u\cup\{t\}}}^{t_{2}}
\Bigg(\prod_{i=2}^{n-1}T_{t_i,\,x_{u\cup\{t\}}}^{t_{i+1}}\Bigg)f\Big](x_t),
\end{equation*}

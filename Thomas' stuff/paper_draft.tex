...
*** Beschouw een proces dat die transitiematrices heeft (voorlopig claimen dat het bestaat). Tonen dat die partial derivatives niet bestaan (+ eventueel claimen dat het proces zelfs well-behaved is) ***
...
*** aantonen dat de convex hull een deel is van de outer partial derivative en claimen dat die er aan gelijk is ***
\exampleend
\end{exmp}
...
\begin{exmp}
*** showing that $\overline{\partial}_+T_0^0$ is indeed convex.

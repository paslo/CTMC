...
We have in the previous sections shown that (conditional) lower expectations can be computed using the operator $L_t^s$. However, in order to make these results practicable, we still require a method to compute the function $L_t^sf$.

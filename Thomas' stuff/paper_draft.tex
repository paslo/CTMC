...
For any two lower transition operators $\lt,\underline{S}\in\underline{\mathcal{T}}$, their composition $\lt\,\underline{S}$ is again a lower transition operator.% $\left(\lt\,\underline{S}\right)\in\underline{\mathcal{T}}$.
\end{proposition}
\begin{proof}
Consider any $f,g\in\gamblesX$, $\lambda\in\realsnonneg$ and $x\in\states$. Since $\underline{T}$ and $\underline{S}$ are both lower transition operators, we then find that
\begin{align*}

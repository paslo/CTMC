...
\end{equation*}
\noindent
For any set $\mathcal{A}$ of square matrices, we define
...
*** uitleggen dat het dat NIET is, meer opgenomen voor compleetheid ***
...
\end{lemma}
\begin{proof}
Just check each of the three defining properties. *** {\bf TODO?} ***
\end{proof}

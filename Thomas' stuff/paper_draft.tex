...
\end{equation*}
Clearly, the limiting behavior of the sequence is therefore governed by the limiting behavior of the geometric power series $s_k$, and since $\lim_{k\to\infty}s_k=\nicefrac{1}{3}$, we find
\begin{equation*}

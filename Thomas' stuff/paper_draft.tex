...
\begin{equation*}
\prod_{i=1}^n(I + \Delta\lrate)\ind{\text{Sick}} = g_{1000} \approx \left[\begin{array}{c}0.008262 \\ 0.140749\end{array}\right]\,,
\end{equation*}
from which we conclude that
\begin{align*}
\underline{P}(X_1 = \text{Sick}\,\vert\,X_0=\text{Sick}) &\equiv \left[L_0^1\ind{\text{Sick}}\right](\text{Sick})
= g_{1000}(\text{Sick}) \pm \epsilon \approx 0.140749 \pm 10^{-3}\,,
\end{align*}
...
\begin{exmp}
{\bf TODO} numeriek voorbeeld voor lower probability van zelfde state op twee tijdpunten.
\exampleend
\end{exmp}

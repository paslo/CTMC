...
\begin{equation*}
\frac{\partial_+}{\partial s}{T_{t,\,x_u}^s}\Bigr\vert_{s=t}
\coloneqq
\lim_{s\to t^{+}}
\frac{
T^s_{t,\,x_u}-T^t_{t,\,x_u}
}{s-t}
=
\lim_{s\to t^{+}}
\frac{
...
\begin{equation*}
\frac{\partial_{-}}{\partial t}{T_{t,\,x_u}^s}\Bigr\vert_{t=s}
\coloneqq
\lim_{t\to s^{-}}
\frac{
T^s_{t,\,x_u}-T^s_{s,\,x_u}
}{s-t}
=
\lim_{t\to s^{-}}
\frac{
...
If these partial derivatives exist, then because of Proposition~\ref{prop:rate_from_stochastic_matrix}, they are guaranteed to belong to $\mathcal{R}$.

Therefore, instead, we will consider outer derivatives.

\begin{equation*}
\frac{\overline{\partial_{+}}}{\partial s}{T^s_{t,\,x_u}}
\Bigr\vert_{s=t}
\coloneqq
???
\end{equation*}

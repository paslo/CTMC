...
\end{equation}\\[-14pt]
and in this way, it becomes clear that the problem of computing $\underline{\mathbb{E}}[f(X_u,X_s)\,\vert\,X_u=x_u]$ is completely equivalent to the problem that we have considered in the previous section, which is to compute lower expectations of the form $\underline{\mathbb{E}}[f(X_s)\,\vert\,X_u=x_u]$.
...
Using this notational convention, the following formalizes the fact that our previous results also apply to functions in $\gambles(\states_{u\cup s})$.
...
\begin{equation*}
\underline{\mathbb{E}}^\mathrm{W}_{\,\rateset,\,\mathcal{M}}[f(X_u,X_s)\,\vert\,X_u=x_u]=\underline{\mathbb{E}}^{\mathrm{WM}}_{\,\rateset,\,\mathcal{M}}[f(X_u,X_s)\,\vert\,X_u=x_u]=\left[L_{t_n}^s f\right](x_u).
\end{equation*}
\end{corollary}
\begin{proof}

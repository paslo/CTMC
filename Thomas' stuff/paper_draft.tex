...
**** gezien dat lower expectations gelinkt zijn aan verzamelingen $\mathcal{P}$, is er een voor de hand liggende manier om zon verzameling te beschrijven?

**** we weten uit voorgaande secties dat het gedrag van stochastische processen beschrijfbaar is met hun outer partial derivatives, wat verzamelingen van rate matrices zijn. We kunnen dit ook omdraaien, door te vragen of een process beschrijfbaar is met een gegeven verzameling rate matrices $\rateset$. Omdat zo'n verzameling niet direct gekoppeld is aan tijdpunten, is dat echter ondergedetermineert; we kunnen wel vragen of een process $P$ \emph{consistent} is met $\rateset$:

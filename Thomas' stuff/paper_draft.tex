...
\end{theorem}
\begin{proof}
By Propositions~\ref{prop:dominating_nonempty_bounded} and \ref{prop:dominatingproperties}, the set $\rateset_{\lrate}$ is non-empty, bounded, and has separately specified rows. The first statement therefore follows directly from Corollary~\ref{cor:lower_operator_is_infimum}.
...
Now, assume that instead $P\notin\wprocesses$. *** ik heb deze al op papier staan, werk hem nu uit... ***
\end{proof}

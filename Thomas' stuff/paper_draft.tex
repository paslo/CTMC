...
The above characterisation leaves some ambiguity about the set of stochastic processes $\mathcal{P}$ with respect to which these lower and upper expectations are taken. %That is, it is unclear which properties are satisfied by the stochastic processes $P$ for which $f_s=\mathbb{E}_P[f(X_s)\,\vert\,X_0]$ satisfies Equation~\eqref{eq:constraintsDamjan}.
%

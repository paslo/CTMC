...
\begin{exmp}
Let $\rateset_1$ and $\rateset_2$ be constructed as in Example~\ref{example:different_sets_same_lower_rate}, and let $\lrate\coloneqq\lrate_1=\lrate_2$ be their common lower transition rate operator. We will show in this example that the corresponding set of dominating rate matrices $\rateset_{\lrate}$ is equal to
\begin{equation*}

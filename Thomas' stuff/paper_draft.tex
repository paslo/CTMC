...
\end{lemma}
\begin{proof}
We have to show that $\mathcal{T}_\rateset^{[t,s]}$ is totally bounded, meaning that for all $\epsilon\in\realspos$, there exists a finite collection of open $\epsilon$-balls centered on elements of $\mathcal{T}_\rateset^{[t,s]}$, such that this collection covers $\mathcal{T}_\rateset^{[t,s]}$. 

...
*** $\underline{\mathbb{E}}_{\rateset,\mathcal{M}}^\mathrm{W}(g(X_0)=\underline{\mathbb{E}}_{\mathcal{M}}(g(X_0)$ is non-trivial; this needs to be shown/proved ***

*** I will first explain the decomposition, showing that everything reduces to $\underline{\mathbb{E}}_{\rateset,\mathcal{M}}^\mathrm{W}(g(X_0)$, then prove that it is equal to $\underline{\mathbb{E}}_{\mathcal{M}}(g(X_0)$, and then explain that this is basically just linear programming ***

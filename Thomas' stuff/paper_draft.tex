...
*** {\bf Hier iets over dat $\lt$ daarom een verzamling dominerende transitie matrices heeft (dit om de vergelijking in volgende sectie explicieter te maken)}

We conclude this section with two results about the set $\underline{\mathcal{T}}$ of all lower transition operators. As the first result shows, this set is closed under composition.

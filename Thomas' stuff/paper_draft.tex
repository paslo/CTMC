...
\begin{tikzpicture}
      ...
      \begin{scope}[x={(plot.south east)},y={(plot.north west)}]
		...
		\node at (0.21,0.94) {$\lambda$};
        \draw (0.134,0.848) -- (0.134,0.86);
        \node at (0.134,0.88) {\scriptsize$0.1$};
        \draw (0.1812,0.848) -- (0.1812,0.86);
        \node at (0.1812,0.88) {\scriptsize$0.2$};
        \draw (0.2284,0.848) -- (0.2284,0.86);
        \node at (0.2284,0.88) {\scriptsize$0.3$};
        \draw (0.2756,0.848) -- (0.2756,0.86);
        \node at (0.2756,0.88) {\scriptsize$0.4$};
        \draw (0.3224,0.848) -- (0.3224,0.86);
        \node at (0.3224,0.88) {\scriptsize$0.5$};

        %\node at (0.06,0.88) {\footnotesize$0.01$};
        

        \node at (0.7,0.47) {$\underline{\mathbb{E}}_\rateset^\mathrm{WHM}[f(X_t)\,\vert\,X_0=a]$};
        \node at (0.8,0.23) {$\underline{\mathbb{E}}_\rateset^\mathrm{WM}[f(X_t)\,\vert\,X_0=a]$};
        \node at (0.85,0.15) {$~~~~=\underline{\mathbb{E}}_\rateset^\mathrm{W}[f(X_t)\,\vert\,X_0=a]$};
      \end{scope}
    \end{tikzpicture}

...
We will in this section formalize the notion of a continuous-time stochastic process, using the framework of full conditional probabilities. This approach differs somewhat from the traditional one, which is motivated below.

...
%---reducing it from being roughly exponential in $t$, to being polynomial.
...
In the main body of his paper, {\v{S}kulj} characterises imprecise continuous-time Markov chains in the following way. For any $f\in\gamblesX$, he considers a time-dependent function $f_s$, which---using our notation---is defined as $f_s\coloneqq T_0^s f$, and then requires that $f_0=f$,

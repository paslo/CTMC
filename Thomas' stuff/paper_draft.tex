...
\subsection{Lower Expectations for Imprecise Continuous-Time Markov Chains} 
Our main object of consideration will be the \emph{lower expectation} with respect to such a set $\mathcal{P}$.

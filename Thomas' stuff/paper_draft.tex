...
(A,C)
\colon
A\in\mathcal{A}_{\geq t},~C\in\filter,~t\in\realsnonneg\big\}\subset\power\times\nonemptypower.
\end{equation*}
...
\begin{equation*}
\inf\Big(\sum_{i=1}^n\lambda_i\ind{C_i}(P(A_i\vert C_i)-\ind{A_i})~\Big\vert~C_0\Big)\geq0,
\end{equation*}

...
*** blabla, algoritme voor 1 tijdstip in de toekomst, meerdere in het verleden.
...
Continuing with the next example, we here illustrate the application of Corollary~\ref{cor:composition_lower_trans} for computing functions defined on multiple time points.

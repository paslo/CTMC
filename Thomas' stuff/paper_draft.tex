...
\end{equation*}
Similarly, for the subsequence $\{\Delta_{i_k}\}_{k\in\nats}$ corresponding to the even terms, we have $\lim_{k\to\infty}\nicefrac{1}{\Delta_{i_k}}(T_0^{\Delta_{i_k}}-I)=Q_e$. It follows that for the directional partial derivative $\smash{\overline{\partial}}_+T_t^t$ corresponding to $P$, at $t=0$, it holds that $\{Q_o,Q_e\}\subseteq \smash{\overline{\partial}}_+T_t^t$.

...
Generally speaking, the inequalities in this proposition can be---and often are---strict; for the first inequality, this will be illustrated in Example~\ref{ex:homogeneousexample}, whereas for the second inequality, Examples~\ref{exmp:num_multivar_func_nonmarkov} and \ref{exmp:num_counterexample_markov} provide an illustration.

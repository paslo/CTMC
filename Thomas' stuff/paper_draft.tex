...
Recall from Proposition~\ref{prop:Markovhassystem} that for all $P\in\wmprocesses$, there is a well-behaved transition matrix system $\mathcal{T}_P$ corresponding to this $P$. 

For any non-empty bounded set $\rateset\subset\mathcal{R}$, let now
\begin{equation*}
\mathcal{T}_\rateset \coloneqq \left\{\mathcal{T}_P\,:\,P\in\wmprocesses_\rateset\right\}\,.
\end{equation*}
We next endow this space $\mathcal{T}_\rateset$ with the following metric $d$,  defined for all $\mathcal{T},\mathcal{S}\in\mathcal{T}_\rateset$ as
\begin{equation}\label{eq:trans_mat_system_metric}
d(\mathcal{T},\mathcal{S}) \coloneqq \sup\left\{\norm{T_t^s - S_t^s}\,:\,t,s\in\realsnonneg, t\leq s\right\}\,,
\end{equation}
where, for all $t,s\in\realsnonneg$, it is understood that $T_t^s\in\mathcal{T}$ and $S_t^s\in\mathcal{S}$.

We have the following results.

\begin{lemma}
Consider any non-empty, bounded and closed set of rate matrices $\rateset$. Then, the metric space $(\mathcal{T}_\rateset,d)$ is complete under the metric $d$, defined as in Equation~\eqref{eq:trans_mat_system_metric}.
\end{lemma}
\begin{proof}
*** todo
\end{proof}
...
\begin{lemma}
Consider any non-empty, bounded and closed set of rate matrices $\rateset$. Then, the metric space $(\mathcal{T}_\rateset,d)$ is totally bounded under the metric $d$, defined as in Equation~\eqref{eq:trans_mat_system_metric}.
\end{lemma}
\begin{proof}
*** todo
\end{proof}
...
\begin{theorem}
Consider any non-empty, bounded and closed set of rate matrices $\rateset$. Then, the metric space $(\mathcal{T}_\rateset,d)$ is compact under the topology generated by the metric $d$, defined as in Equation~\eqref{eq:trans_mat_system_metric}.
\end{theorem}
\begin{proof}

...
\item **** Zijn pointers naar wat dit later mogelijk gaat maken een "main result"? tractable algoritmes, GBR, hidden ictmc, analytische oplossingen voor boeiende vragen (tijd tot absorbtie, tijd in state),...
\end{enumerate}

...
In this example, the defining assumptions of a continuous-time Markov chain impose rather strict conditions on our model. First of all: we need to provide exact values for the initial probability of a person being sick, and for the two rate parameters. Secondly, these rate parameters should 

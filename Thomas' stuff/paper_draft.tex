...
{T^t_{t,\,x_u}}$ and $Q\notin\rateset$. We will show that this leads to a contradiction. We consider two (possibly overlapping) cases: $\smash{Q\in\overline{\partial}_{+}
{T^t_{t,\,x_u}}}$ and $\smash{Q\in\overline{\partial}_{-}
{T^t_{t,\,x_u}}}$.

If $\smash{Q\in\overline{\partial}_{+}
{T^t_{t,\,x_u}}}$, it follows from Equation

...
\subsection{Transition Matrices and Systems}\label{sec:trans_rate_matrices}
...
\begin{proposition}
\label{prop:systemQ}
For any $Q\in\mathcal{R}$, $\mathcal{T}_Q$ is a transition matrix system.
\end{proposition}
\begin{proof}
*** trivial ***
\end{proof}
...
A \emph{transition matrix system} $\mathcal{T}$ is called \emph{well-behaved} if 
...
\begin{proposition}
\label{prop:systemQ_well_behaved}
For any $Q\in\mathcal{R}$, the transition matrix system $\mathcal{T}_Q$ is well-behaved.
\end{proposition}
\begin{proof}
*** trivial ***
\end{proof}

...
Conversely, if $P$ is a coherent conditional probability, it follows from Reference~\cite[Theorem 4]{regazzini1985finitely}  that $P$ can be extended to a coherent conditional probability $P^*$ on the set $\power\times\nonemptypower$, which, because of Proposition~\ref{prop:fullcoherent}, is a full conditional probability.
\end{proof}

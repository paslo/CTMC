...
A second conclusion that we can draw from Theorem~\ref{theo:dominating_rate_processes_max_set}, is that it vindicates our choice to focus on \emph{well-behaved} stochastic processes---rather than, say, continuous or differentiable stochastic processes. ***blabla
...
\subsection{Computing Lower Expectations with Corresponding Lower Transition Operators}

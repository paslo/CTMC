...
We will start by considering conditional lower expectations, where the conditioning is done with respect to the states $x_u$ at a finite sequence of time points $u$. In this context, it makes sense to distinguish between two different classes of functions. 

...
\end{align}
For large enough $k\in\nats$, a similar statement holds for $\presuper{k}T_0^{t}$. In particular, Equation~\eqref{eq:def:sequenceinexample3} implies that

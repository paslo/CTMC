...
\end{equation*}
with $\underline{f}_0=\overline{f}_0=f$, and proves that $\underline{f}_s\leq f_s\leq\overline{f}_s$. In practice, it suffices to restrict attention to either one of these two bounds, because they are related by conjugacy, in the sense that $\smash{\underline{f}_0=-\overline{f}_0}$ implies that $\smash{\underline{f}_s=-\overline{f}_s}$. 
Most of {\v{S}}kulj's subsequent results focus on the upper bound $\overline{f}_s$. In our further discussion of his work, however, we will focus on the lower bound $\underline{f}_s$ instead, because it allows for a more elegant comparison with our own work.

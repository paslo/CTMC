...
\end{equation}
Since $\rateset$ is non-empty, bounded, and convex, Theorem~\ref{theo:aanelkaarplakken} now implies the existence of a process $P\in\wprocesses_\rateset$ such that for all $x_v\in\states_v$ and $x_w\in\states_w$:
\begin{equation*}

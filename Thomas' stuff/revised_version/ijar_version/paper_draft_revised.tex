...
Finally, the proofs of our results are gathered in an appendix, where they are organised by section and ordered by chronological appearance. This appendix also contains some additional lemmas that are needed only in the proofs but which may nevertheless be of independent interest.

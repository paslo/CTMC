...
Yes, it can rather directly be understood as the continuous-time analogue to separately specified credal networks. We have added a footnote remarking on this to Definition 24.

**** Voetnoot toegevoegd, moet alleen nog een referentie bij
...
Thanks for spotting this inconsistency. We have changed the notation of the power set to $\wp$.

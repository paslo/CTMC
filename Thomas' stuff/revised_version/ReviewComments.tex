...
While you are right that our use of notation here is rather informal, we nevertheless think it is intuitive. Furthermore, because we also use similar notation for functions, writing the full statement explicitly would make the discussion rather verbose.
...
We have weakened the statement to make it explicit that we only believe this problem to be harder. 

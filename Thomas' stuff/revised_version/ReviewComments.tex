...
{\color{green}
Yes, our notion of separately specified rows can rather directly be understood as the continuous-time analogue the separately specified local models that are often adopted in credal networks. We now explain this in a footnote at the end of Definition 24.
}

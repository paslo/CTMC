...
% uiteindelijk besloten om dit niet te doen, aangezien het in die toepassing niet expliciet gemaakt wordt of het over de WM of WHM versie gaat
...
\textcolor{blue}{*** DE REFERENCE NAAR DE ARXIV VERSIE MOET NOG DOORGEVOERD WORDEN IN DE BIBTEX FILE VAN DE IJAR VERSIE ***}
...
\textcolor{blue}{*** IS INMIDDELS AANGEPAST (zowel in Sectie 4.1, in Sectie 7.1 ***}

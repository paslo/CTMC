...
We considered the problem of performing inference with \emph{imprecise continuous-time hidden Markov chains}; an extension of \emph{imprecise continuous-time Markov chains} (ICTMC's) obtained by augmenting such ICTMC's with random \emph{output} variables. %We focussed on the corresponding inference problem,

...
\end{equation*}
whenever this limit exists, and is left undefined, otherwise. In order for this limit to exist, we require that $\mathbb{E}_P[\phi_u(y_u\vert X_u)]>0$. Under this assumption, we have the following result.

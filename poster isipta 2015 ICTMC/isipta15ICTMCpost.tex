...
In order to find the corresponding, if any, flipping time $t_1$, we take the derivative of $e^{tQ}\underline{f}_{t_1}$ evaluated at $t=0$.
...
Due to the values of $f$, there are multiple $Q$, such that $Qf$ is pointwise minimum. 

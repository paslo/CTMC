...
Among the solutions of $t_1$, the smallest positive real one is the first flipping time and the corresponding matrix is the matrix $Q_{\tau_{1}}$.
...
\vspace{0.5cm}
 ...
 %    \end{pmatrix*}
 % \]
 where, $\lambda_{2}\in\{1,3\}$ and $\mu_{3}\in\{2,5\}$.
 Let $\matrices^*$ be the set containing all the matrices of the above form.
